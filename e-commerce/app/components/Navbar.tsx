        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <Link href="/cart" className="hover:bg-gray-700 px-3 py-2 rounded-md">
                Cart
              </Link>
            </div>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/products" className="block hover:bg-gray-700 px-3 py-2 rounded-md">
              Products
            </Link>
            <Link href="/cart" className="block hover:bg-gray-700 px-3 py-2 rounded-md">
              Cart
            </Link>
          </div>
        </div>
